...
var m = __webpack_require__(0);//MVC JS Framework
...
var ReservationComponent = {
	...
	view: function(ctrl,args){
		return m(".reserve__comp__container",{onclick:ReservationComponent.changeSeatState},[
			...
			m("hr"),
			ReservationComponent.seats.map(function(state,seatPosition){
				return m(".reserve__comp__container__seat--"+SEAT_STATE[state],
					{"data-pos":seatPosition})
			}),
	...
	changeSeatState : function(e){
			...
			var current_seat_status = ReservationComponent.seats[current_seat_pos];
			if(current_seat_status === AVAILABLE){
				ReservationComponent.seats[current_seat_pos] = SELECTED;
				ReservationComponent.selected_seats.push(current_seat_pos);
			}else if(current_seat_status === SELECTED){
				ReservationComponent.seats[current_seat_pos] = AVAILABLE;
...
var reservation_component = __webpack_require__(1);
